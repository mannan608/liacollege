            ...
            <div class="row">
                <div class="col-12">
                    <div class="breadcrumb-content">
                        <h2 class="section-title" style="font-weight: bold;">CHC33021<br />Diploma of Community Services
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="rts-program-single-header">
                <div class="row align-items-center g-3">
                    <div class="col-lg-6">
                        <h3 class="rts-section-title">CHC52021 Diploma of Community Services</h3>
                    </div>
                    <div class="col-lg-6">
