                ...
                <div class="p-8">
                        ...
                        <div class="space-y-5">
                            ...
                            <div>
                                ...
                                <div class="grid md:grid-cols-2 gap-3">
                                    ...
                                    <label class="border rounded-xl p-3 flex gap-2">
                    ...
                    <div class="flex justify-between mt-8">
                        ...
                        <button type="button"
                                onclick="nextStep()"
                                id="nextBtn"
                                class="ml-auto bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-xl font-semibold">
                            Next
                        </button>

                        <button type="submit"
                                id="submitBtn"
                                class="hidden ml-auto bg-green-500 hover:bg-green-600 text-white px-8 py-3 rounded-xl font-semibold">
                            Submit Application
                        </button>
