    ...
    <div class="border-b px-5 md:px-10 py-5 flex flex-col md:flex-row gap-4 md:items-center md:justify-between">
        ...
        <div class="flex items-start gap-2">
            <div class="flex-shrink-0">
                <svg class="lg:w-10 lg:h-10 md:w-8 md:h-8 w-7 h-7 text-[#0c4a6e]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" fill="currentColor">
            ...
            <h2 class="font-extrabold text-lg md:text-xl lg:text-2xl text-[#0c4a6e] flex-1 leading-tight">
